...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-1$ojxt4+lhbl)1=#yjpg)noe5p_x6i$9kwn#1j=9!!ru0mc!a-')
...
MAX_DOCUMENT_SIZE = int(os.getenv('MAX_DOCUMENT_SIZE', 20)) * 1024 * 1024
